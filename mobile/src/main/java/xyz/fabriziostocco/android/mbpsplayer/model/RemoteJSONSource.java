...
public class RemoteJSONSource implements MusicProviderSource {
    ...
    protected static final String CATALOG_URL = "https://mbps.fabriziostocco.xyz/fabriziostocco-media/music.json";
    ...
    private JSONObject fetchJSONFromUrl(String urlString) throws JSONException {
        LogHelper.d(TAG,"fetchJSONFromUrl");
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                LogHelper.d(TAG, "reader.readline", line);
                sb.append(line);
            }
