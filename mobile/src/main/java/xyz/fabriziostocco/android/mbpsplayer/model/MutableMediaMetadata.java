...
public class MutableMediaMetadata {
    ...
    private static final String TAG = LogHelper.makeLogTag(MutableMediaMetadata.class);
    ...
    public MutableMediaMetadata(String trackId, MediaMetadataCompat metadata) {
        LogHelper.d(TAG, ": MutableMediaMetadata");
