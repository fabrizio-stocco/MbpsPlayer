...
public abstract class ActionBarCastActivity extends AppCompatActivity {
    ...
    private final VideoCastConsumerImpl mCastConsumer = new VideoCastConsumerImpl() {
        ...
        public void onFailed(int resourceId, int statusCode) {
            LogHelper.d(TAG, "VideoCastConsumerImpl onFailed ", resourceId, " status ", statusCode);
        }

        @Override
        public void onConnectionSuspended(int cause) {
            LogHelper.d(TAG, "VideoCastConsumerImpl onConnectionSuspended() was called with cause: ", cause);
        }

        @Override
        public void onConnectivityRecovered() {
            LogHelper.d(TAG, "VideoCastConsumerImpl connessione CAST ristabilita");
        }
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if (mMediaRouteMenuItem.isVisible()) {
                            LogHelper.d(TAG, "VideoCastConsumerImpl Cast Icon is visible");
                            showFtu();
                        }
                    }
                }, DELAY_MILLIS);
