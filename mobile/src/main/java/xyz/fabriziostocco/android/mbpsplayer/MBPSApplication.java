...
import xyz.fabriziostocco.android.mbpsplayer.ui.FullScreenPlayerActivity;
 ...
 */
public class MBPSApplication extends Application {

    private static final String TAG = LogHelper.makeLogTag(MBPSApplication.class);
