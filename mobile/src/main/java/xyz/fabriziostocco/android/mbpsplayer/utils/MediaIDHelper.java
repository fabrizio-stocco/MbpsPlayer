...
package xyz.fabriziostocco.android.mbpsplayer.utils;
...
public class MediaIDHelper {
    ...
    private static boolean isValidCategory(String category) {
        LogHelper.d(TAG, ": isValidCategory");
    ...
    public static String extractMusicIDFromMediaID(@NonNull String mediaID) {
        LogHelper.d(TAG, ": extractMusicIDFromMediaID");
    ...
    public static String extractBrowseCategoryValueFromMediaID(@NonNull String mediaID) {
        LogHelper.d(TAG, ": extractBrowseCategoryValueFromMediaID");
